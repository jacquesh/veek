...
set CompileFiles= ..\src\main.cpp ..\src\render.cpp ..\src\audio.cpp ..\src\ringbuffer.cpp ..\src\platform.cpp ..\src\logging.cpp ..\src\user.cpp ..\src\user_client.cpp ..\src\network.cpp
REM ..\src\video.cpp ..\src\videoinput.cpp ..\src\crossCap.cpp ..\src\happyhttp.cpp
set CompileFlags= -nologo -Zi -Gm- -W4 -D_CRT_SECURE_NO_WARNINGS -Od -DNOMINMAX -MTd -EHsc- -DBUILD_VERSION=\"%VersionHash%_%BuildDate%_%BuildTime%\" -DSOUNDIO_STATIC_LIBRARY -DVIDEO_DISABLED
...
pushd build
cl %CompileFlags% %CompileFiles% %IncludeDirs% -link -LIBPATH:..\lib %LinkLibs% -INCREMENTAL:NO -OUT:main.exe
popd
